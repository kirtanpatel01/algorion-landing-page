      ...
      <Container className="md:rounded-xl bg-white shadow-md">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-4 px-3 sm:px-4 py-3 sm:py-4 flex-1">
            ...
            <nav className="hidden items-center gap-3 md:gap-6 font-medium  text-slate-600 sm:flex">
              {links.map((link) => (
          ...
          <div className="hidden sm:flex items-center gap-2 px-2 sm:px-4 py-3 sm:py-4">
            <Link href="/auth/login">
              <Button variant="outline" className="px-2 sm:px-3 py-1.5 ">
                Login
              </Button>
            </Link>
            <Link href="/auth/signup">
              <Button variant="primary" className="px-2 sm:px-3 py-1.5">
                Get Started
              </Button>
            </Link>
          </div>
