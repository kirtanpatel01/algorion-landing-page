...
export default function SectionBadge({
  ...
  return (
    <div className={`mb-6 flex items-center justify-center gap-3 sm:gap-6 ${className}`}>
      ...
      <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-border bg-gradient px-3 sm:px-4 py-1 sm:py-1.5 text-[11px] sm:text-xs text-primary">
